    ...
    <div class='sidebar-post-footer'>
      ...
      <div ref='like' class='sidebar-post-footer-likes' @click='likePost'>
        <div class='sidebar-post-footer-likes-hearts'>
          <svg ref='miniHeartGray' class='mini-heart-gray' width="16" height="15" viewBox="0 0 16 15" fill="none"
          ...
          <svg ref='miniHeartRed' class='mini-heart-red' width="20" height="20" viewBox="0 0 20 20" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <path
